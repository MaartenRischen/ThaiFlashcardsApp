...
export function FeedbackFooterClient() {
  ...
  return (
    <>
      <div 
        className={`w-full flex flex-col items-center justify-center bg-[#181818] border-t border-gray-700 py-4 px-4 mt-4 shadow-lg ${
          !isCardFlipped ? 'sticky bottom-0 z-30' : ''
        }`}
      >
